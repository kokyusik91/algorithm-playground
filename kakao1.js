...
// const privacyObj = [{ start: '2021.05.02', end : '2021.'}];
...
console.log(calculateEndDate('2022.02.19', 3));
...
privacies.forEach((privacie, index) => {
  privaciesObj.push({
    ...
    rules: termsObj[privacie.split(' ')[1]],
      ...
      privacie.split(' ')[0],
      termlObj[privacie.split(' ')[1]],
    ),
    number: index + 1,
  });
});

console.log(privaciesObj);
...
console.log(compareDate('2021.11.01', '2021.11.01'));
